...
class ShippingMultipleController extends AbstractShoppingController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $ProductIncTaxOrderType = $this->orderItemTypeRepository->find(OrderItemType::PRODUCTINCTAX);
                ...
                foreach ($multiples as $items) {
                    foreach ($items as $item) {
                        ...
                        $OrderItem->setShipping($Shipping)
                            ...
                            ->setOrderItemType($ProductClass->getZeiKubun() == 0 ? $ProductOrderType : $ProductIncTaxOrderType);
