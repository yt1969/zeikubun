...
class OrderItemType extends \Eccube\Form\Type\Admin\OrderItemType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event) {
            ...
            if (!isset($OrderItem['tax_rate']) || StringUtil::isBlank($OrderItem['tax_rate'])) {
                ...
                if ($orderItemTypeId == OrderItemTypeMaster::PRODUCT or $orderItemTypeId == OrderItemTypeMaster::PRODUCTINCTAX) {
        ...
        $builder->addEventListener(FormEvents::POST_SUBMIT, function (FormEvent $event) {
            ...
            switch ($OrderItemType->getId()) {
                ...
                case OrderItemTypeMaster::PRODUCTINCTAX:
                    ...
                    if (null === $OrderItem->getTaxDisplayType()) {
                        ...
                        $OrderItem->setTaxDisplayType($ProductClass->getZeiKubun() == 0 ? $TaxExclude : $TaxInclude);
                    }
                    break;
                default:
                    if (null === $OrderItem->getRoundingType()) {
